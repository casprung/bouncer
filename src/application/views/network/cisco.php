...
<body onload="document.WLCLoginForm.submit()">
	<div class="ui middle aligned center aligned grid">
		<div class="column">
			<div class="ui active massive indeterminate text loader">Logon in progress</div>
			<form name="WLCLoginForm" method="post" action="<?php echo $switch_url; ?>">
				<input name="username" type="hidden" value="<?php echo $username; ?>">
				<input name="password" type="hidden" value="<?php echo $hashedpwd; ?>">
				<input name="redirectUrl" type="hidden" value="<?php echo $url; ?>">
				<input name="buttonClicked" type="hidden" value="4">
			</form>
		</div>
	</div>
</body>
